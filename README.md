...
🤖 The AI ModelThe system utilizes a Deep Q-Network (DQN) architecture:Algorithm: DQN with Experience Replay and Target Network stabilization.Environment: Custom OpenAI Gymnasium grid-world (20x20).State Space: 4D vector (Agent X-Y, Package 1 status, Package 2 status).Action Space: Discrete (Up, Down, Left, Right, Idle).
